...
public class Fabrica {
    ...
    public void adicionarEstoqueProduto(Chocolate chocolate) {
        if (listaDeProdutos.isEmpty()) {
            EntradaSaida.mensagemErroSemCadastro();
        } else {
            int selecionarProduto = EntradaSaida.solicitarCodigoProduto();
    ...
    public void gerarListaProdutosCadastrados() {
        ...
        if (listaDeProdutos.isEmpty()) {
            ...
            for (Chocolate chocolate : listaDeProdutos) {
                listaCadastrados += " | Código: " + chocolate.getCodigo() + " | Estoque: " + chocolate.getEstoque() +" | Tipo chocolate: "+ chocolate.getTipoChocolate()+ " | Peso: " + chocolate.getPeso() + " | Calorias: " +chocolate.getCalorias() + " | Preço: R$" + df.format(chocolate.getPreco()) + "\n";
            }
