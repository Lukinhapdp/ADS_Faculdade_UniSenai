...
cálculo da média aritmética dessas notas. Caso o aluno tire uma nota maior do que 7 		 //Lucas Adriano Pereira 06/05/2023
 ...
 programa
{
	...
	// método com retorno
	// real quer dizer o tipo de retorno dessa função vai real
